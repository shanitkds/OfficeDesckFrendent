...
import HrRequestStatusView from '../../components/HrRequestStatusView';
          ...
          <div className="bg-white rounded-2xl w-full max-w-2xl overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-200">
            ...
            <div className="px-8 pb-8">
              ...
              <div className="mt-8 pt-6 border-t border-gray-100 flex justify-end gap-3">
                <button className="flex items-center gap-2 px-6 py-2 bg-indigo-600 text-white rounded-lg font-bold shadow-lg shadow-indigo-100 hover:bg-indigo-700 transition-all" onClick={()=>navigate(`/hr/edit/${selectedUser.id}`)}>
                  <MdEdit size={20} /> Edit Profile Request
                </button>
              </div>
            </div>
          </div>
