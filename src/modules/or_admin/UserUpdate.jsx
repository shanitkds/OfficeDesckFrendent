...
function UserUpdate() {
    ...
    const getuser = async () => {
        try {
            const response = await axios.get(`${BASE_URL}/api/org_admin/oruser_creation/${id}/`,TOCKEN_ONLY());
            ...
            // Corrected mappings per your request
    ...
    const handleUpdate = async (e) => {
        ...
        // Logic: Only append to FormData if the user selected a NEW file (File object)
        // This prevents sending the existing URL string back as a file upload
